...
func (iu *ItemUpdate) SetCategory(i *ItemCategory) *ItemUpdate {
	return iu.SetCategoryID(i.ID)
}
...
// SetCategory sets the "category" edge to the ItemCategory entity.
func (iuo *ItemUpdateOne) SetCategory(i *ItemCategory) *ItemUpdateOne {
	return iuo.SetCategoryID(i.ID)
}

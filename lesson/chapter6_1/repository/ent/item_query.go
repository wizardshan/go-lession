...
func (iq *ItemQuery) QueryCategory() *ItemCategoryQuery {
	query := &ItemCategoryQuery{config: iq.config}
...
func (iq *ItemQuery) WithCategory(opts ...func(*ItemCategoryQuery)) *ItemQuery {
	query := &ItemCategoryQuery{config: iq.config}

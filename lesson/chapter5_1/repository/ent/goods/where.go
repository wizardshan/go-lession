...
func CategoryID(v int) predicate.Goods {
	return predicate.Goods(func(s *sql.Selector) {
...
func CategoryIDEQ(v int) predicate.Goods {
	return predicate.Goods(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCategoryID), v))
	})
}
...
func CategoryIDNEQ(v int) predicate.Goods {
	return predicate.Goods(func(s *sql.Selector) {
...
func CategoryIDIn(vs ...int) predicate.Goods {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CategoryIDNotIn(vs ...int) predicate.Goods {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CategoryIDIsNil() predicate.Goods {
	return predicate.Goods(func(s *sql.Selector) {
...
func CategoryIDNotNil() predicate.Goods {
	return predicate.Goods(func(s *sql.Selector) {
...
func HasCategory() predicate.Goods {
	return predicate.Goods(func(s *sql.Selector) {
...
func HasCategoryWith(preds ...predicate.GoodsCategory) predicate.Goods {
	return predicate.Goods(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
